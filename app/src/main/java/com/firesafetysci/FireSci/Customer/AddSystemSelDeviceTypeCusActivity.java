...
public class AddSystemSelDeviceTypeCusActivity extends AppCompatActivity implements DeviceTypeAdapter.OnDeviceTypeClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_system_sel_device_cus);
    ...
    private void setOnClickListeners() {
        continueButton.setOnClickListener(v -> {
            ...
            if (selectedDeviceType.isEmpty()) {
                Snackbar.make(findViewById(R.id.continueButtonAddSysSelDevCus), "Please select the device type and try again!", 1250)
                        .setAction("Action", null)
                        .setActionTextColor(Color.WHITE)
                        .setBackgroundTint(getResources().getColor(R.color.snackbarColor))
                        .show();

            } else if (!CommonFunctions.isNetworkConnected(AddSystemSelDeviceTypeCusActivity.this)) {
                Snackbar.make(findViewById(R.id.continueButtonAddSysSelDevCus), "Please connect to the internet!", 1250)
                        .setAction("Action", null)
                        .setActionTextColor(Color.WHITE)
                        .setBackgroundTint(getResources().getColor(R.color.snackbarColor))
                        .show();
                ...
                Intent intent = new Intent(AddSystemSelDeviceTypeCusActivity.this, AddNewSystemCustomerActivity.class);
                startActivityForResult(intent, 1);
                AddNewSystemCustomerActivity.location = location;
                AddNewSystemCustomerActivity.enteredSerialNumber = enteredSerialNumber;
