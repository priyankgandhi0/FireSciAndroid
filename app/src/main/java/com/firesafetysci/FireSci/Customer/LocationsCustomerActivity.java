...
public class LocationsCustomerActivity extends AppCompatActivity implements LocationAdapter.OnLocationClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_locations_customer);

        initViews();

        Toolbar locationsActivityToolbar = findViewById(R.id.locationsCustomerActivityToolbar);
    ...
    protected void onResume() {
        ...
        if (!CommonFunctions.isNetworkConnected(LocationsCustomerActivity.this)) {
